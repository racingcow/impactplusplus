        ...
        ig.UITextBubbleChoice = ig.global.UITextBubbleChoice = ig.UITextBubble.extend(/**@lends ig.UITextBubble.prototype */{
            ...
            resize: function ( force ) {
                ...
                if ( this.message ) {
                    ...
                    var scaleMod = 1; // this.message.scale / this.scale;
                    ...
                    // console.log('ig.system.scale = ' + this.scale.toString());
                    // console.log('this.scale = ' + this.scale.toString());
                    // console.log('this.scaleMod = ' + this.scaleMod.toString());
                    // console.log('message scale ' + this.message.scale);
                    // console.log('message scaleMod ' + this.message.scaleMod);
                    // console.log('calculated message scaleMod ' + scaleMod);
                    ...
                    if (this.choiceMessages) {
                        ...
                        for (var i = 0; i < this.choiceMessages.length; i++) {
                            ...
                            cScaleMod = 1; //choice.scale / this.scale;
                            ...
                            console.log('choiceSizeY' + choiceSizeY);
                            ...
                            //console.log('scale of choice = ' + choice.scale.toString());

                            //console.log('padding Y ' + this.choicePaddingY );
                            console.log('offsety ' + choice.offset.y );
                            console.log('sizey ' + choice.size.y );
                            console.log('getSizeDrawY ' + choice.getSizeDrawY() );

                            choice.moveTo( this.message, {
                                matchPerformance: true,
                                offsetPct: { x: 0, y: 1 },
                                //offset: { x: 0, y: this.choiceTopPaddingY + choiceOffset }
                                offset: { x: 0, y: this.choiceTopPaddingY + choicesSizeY}
                            } );
                            ...
                            button = this.choiceButtons[i];
                            bScaleMod = 1; //button.scale / this.scale;
                        ...
                        this.size.y = this.padding.y + messageSizeY + this.choiceTopPaddingY + choicesSizeY + this.padding.y + this.triangleLength;
                        console.log('this.size.y = ' + this.size.y.toString());
